...
<br>
<br>
<font face="Arial" size="2px">Create User Account page</font>
...
{
$sql="INSERT INTO users (FNAME,mNAME,lname,user_id,sex,level,phone_no,username ,password,confirmpassword,status)
VALUES
('$_POST[fname]','$_POST[mname]','$_POST[lname]','$_POST[user_id]','$_POST[sex]','$_POST[actype]','$_POST[phone]','$_POST[username]','$_POST[password]','$_POST[confirmpassword]','1')";
  ...
  <table width="426px" align="center">
	...
	<td><font color="red">*</font>&nbsp;<font size="1">required.</font></td>
		 ...
		 <tr>
		   ...
		   <td><input type="password" name="rpassword" required x-moz-errormessage="Re-enter password" id="cpassword"></td>
	     </tr>
<tr>
	<br><br><br>
...
<a href="#top"><img src="img/arrow_up.png" width="40px" title="Scroll Back to Top"></a>
		...
		<a href="admin.php">Home</a>&nbsp;|&nbsp;<a href="viewcom.php">View Comment</a>&nbsp;|&nbsp;<a href="Postinfo.php">Post Info</a>&nbsp;</font></div>
