...
<img src="imag/brudms.png" align="center" width="490px" height="120px"></p>
</td>
</tr>
<!--End Of Header-->
<!--Main menus-->
...
function isAlphabet(elem, helperMsg){
  ...
  <form id="form1" name="login" method="POST" action="comments.php" onsubmit='return formValidation()'>
